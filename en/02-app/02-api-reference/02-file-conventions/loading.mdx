...
By default, this file is a [Server Component](/docs/getting-started/react-essentials#server-components) - but can also be used as a Client Component through the `"use client"` directive.
...
```js filename="app/feed/loading.js" switcher
export default function Loading() {
  // Or a custom loading skeleton component
  return 'Loading...'
}
