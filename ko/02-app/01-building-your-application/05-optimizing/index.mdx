...
<PagesOnly>
The Head Component in Next.js allows you to modify the `<head>` of a page. Learn more in the [Head Component](/docs/pages/building-your-application/optimizing/head) documentation.
</PagesOnly>
