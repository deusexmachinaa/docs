...
```jsx filename="cypress/e2e/app.cy.js"
describe('Navigation', () => {
...
```js filename="\_\_mocks\_\_/fileMock.js"
module.exports = {
  src: '/img.jpg',
  height: 24,
  width: 24,
...
```js filename="\_\_mocks\_\_/styleMock.js"
module.exports = {}
```
...
```jsx filename="\_\_tests\_\_/index.test.jsx"
...
```jsx filename="\_\_tests\_\_/snapshot.js"
